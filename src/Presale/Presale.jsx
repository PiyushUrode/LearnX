...
import usdticon from "../assets/icons1.png"
import learnxicon from "../assets/learnx.png"
import Bnb from "../assets/Bnb.png"
import data from "../Presale/Data.json";
            ...
            <div className="w-full max-w-xl bg-black text-white p-6 rounded-lg shadow-lg  ">
                ...
                <div className="mt-2 text-center">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div class="relative">
                            <label class="block text-xl mb-2 text-white text-left">You pay</label>
                            <div class="relative   rounded-3xl border border-yellow-600  ">
                                ...
                                <input
                                    ...
                                    class=" rounded-3xl  w-full pl-10 pr-3 py-2 bg-[#131111]   outline-none focus:ring-2 focus:ring-yellow-600 text-white placeholder-gray-400"
                                />
                            </div>
                        </div>

                        <div class="relative">
                            <label class="block text-xl mb-2 text-white text-left">You Recieve</label>
                            <div class="relative  rounded-3xl border border-yellow-600 ">
                                ...
                                <input
                                    ...
                                    class="w-full  rounded-3xl   pl-10 pr-3 py-2 bg-[#131111]   outline-none focus:ring-2 focus:ring-yellow-500 text-white placeholder-gray-400"
                                />
                            </div>
                        </div>
                    </div>
